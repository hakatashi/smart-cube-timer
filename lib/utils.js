...
import {Vector, Line} from 'sylvester';
...
export const cartesianToPolar = (vector) => {
	const [x, y, z] = vector.elements;
	...
	const θ = Math.atan2(Math.sqrt(x ** 2 + y ** 2), z);
...
console.log(getRotationNotation({from: 'U', to: 'L'}));
console.log(getRotationNotation({from: 'U', to: 'D'}));
console.log(getRotationNotation({from: 'R', to: 'D'}));
console.log(getRotationNotation({from: 'R', to: 'U'}));
console.log(getRotationNotation({from: 'R', to: 'F'}));
console.log(getRotationNotation({from: 'F', to: 'U'}));
