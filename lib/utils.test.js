...
describe('utils', () => {
	...
	describe('getRotationOrientation', () => {
		test('works', () => {
			expect(getRotationOrientation({from: 'U', to: 'R'})).toEqual({left: 'D', down: 'R'});
			expect(getRotationOrientation({from: 'U', to: 'B'})).toEqual({left: 'L', down: 'B'});
			expect(getRotationOrientation({from: 'U', to: 'U'})).toEqual({left: 'L', down: 'D'});
			expect(getRotationOrientation({from: 'U', to: 'D'})).toEqual({left: 'R', down: 'U'});
		});
	});
